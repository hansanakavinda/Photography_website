...
if(isset($_SESSION['delid'])) {
  ...
  <section class="content">
   ...
   <tr>
				...
				if($conn){
					$queDel="DELETE FROM pac WHERE pacID='$id'";
					if(mysqli_query($conn,$queDel)){
					echo '<h3>SUCCESSFULLY DELETED!</h3><br />
				 Package ID: '.$id.' suceessfully deleted from the database<br />
				<a href="pac.php">BACK</a>';
					}//del query
				}//conn
				else{
					echo 'Error while connecting to database'.mysqli_error($conn);
				}
