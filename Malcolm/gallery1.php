          ...
          if($conn){
                  ...
                  if(mysqli_query($conn,$queSea)){
                      ...
                      $data=mysqli_query($conn,$queSea);
                          ...
                          echo '<img src="'.$val['path'].'" alt="Wildlife" class="gallery-img" onclick="openLightbox(this)">';
                          } // while
                  } // mysqli_query
          } // $conn
          else {
