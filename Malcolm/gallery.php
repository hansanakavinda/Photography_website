...
<body>
    ...
    <section class="content">
        <section class="gallery">
            <h3 class="current">Scottish landscape</h3>
            <h3><a href="gallery1.php">natural wildlife</a></h3>
            <h3><a href="gallery2.php">coastal birds</a></h3>
            <?php
          $conn=mysqli_connect('localhost','root','','malcolm');
    
          if($conn){
                  $queSea="SELECT * FROM gal WHERE category='Landscape'";
                  ...
                  if(mysqli_query($conn,$queSea)){
                      ...
                      $data=mysqli_query($conn,$queSea);
                          ...
                          echo '<img src="'.$val['path'].'" alt="Landscape" class="gallery-img" onclick="openLightbox(this)">';
                          } // while
                  } // mysqli_query
          } // $conn
          else {
